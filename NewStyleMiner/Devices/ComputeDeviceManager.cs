    ...
    public class ComputeDeviceManager
    {
        public static class Query {
            ...
            private static void showMessageAndStep(string infoMsg) {
                LoadingViewModel.LoadingLabelText = infoMsg;
            }

            //public static IMessageNotifier MessageNotifier { get; private set; }
            public static LoadingViewModel LoadingViewModel { get; private set; }
            public static MainViewModel MainViewModel { get; private set; }
            public static IDialogCoordinator _dialogCoordinator { get; private set; }

            public static async Task QueryDevices(LoadingViewModel loadingViewModel, MainViewModel mainviewModel, IDialogCoordinator dialogCoordinator) {
                ...
                await WindowsDisplayAdapters.QueryVideoControllers(_dialogCoordinator);
                // Order important CPU Query must be first
                // #1 CPU
                await CPU.QueryCPUs(_dialogCoordinator);
                // #2 CUDA
                ...
                if (ConfigManager.GeneralConfig.DeviceDetection.DisableDetectionAMD) {
                    ...
                    await AMD.QueryAMD(_dialogCoordinator);
                }
                ...
                if (showWarning && CudaDevices.Count != NVIDIA_count && _currentNvidiaSMIDriver.IsLesserVersionThan(NVIDIA_MIN_DETECTION_DRIVER)) {
                    ...
                    await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                    {
                        ...
                        var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("Compute_Device_Query_Manager_NVIDIA_RecomendedDriver_Title"), String.Format(International.GetText("Compute_Device_Query_Manager_NVIDIA_Driver_Detection"),
                            minDriver, recomendDrvier), MessageDialogStyle.Affirmative, mySetting);
                    }));
                ...
                if (showWarning && _currentNvidiaSMIDriver.IsLesserVersionThan(NVIDIA_RECOMENDED_DRIVER) && !isNvidiaErrorShown && _currentNvidiaSMIDriver.leftPart > -1) {
                    ...
                    await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                    {
                        ...
                        var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("Compute_Device_Query_Manager_NVIDIA_RecomendedDriver_Title"), String.Format(International.GetText("Compute_Device_Query_Manager_NVIDIA_Driver_Recomended"),
                            recomendDrvier, nvdriverString, recomendDrvier), MessageDialogStyle.Affirmative, mySetting);
                    }));
                ...
                if (ConfigManager.GeneralConfig.ShowDriverVersionWarning && total_Sys_RAM < total_GPU_RAM * 0.6) {
                    ...
                    await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                    {
                        ...
                        var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("Warning_with_Exclamation"), International.GetText("VirtualMemorySize_BAD"), MessageDialogStyle.Affirmative, mySetting);
                    }));
            ...
            static class WindowsDisplayAdapters {
                ...
                public static async Task QueryVideoControllers(IDialogCoordinator dialogCoordinator) {
                    ...
                    if (ConfigManager.GeneralConfig.ShowDriverVersionWarning && !allVideoContollersOK) {
                        ...
                        await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                        {
                            ...
                            var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("QueryVideoControllers_NOT_ALL_OK_Title"), msg, MessageDialogStyle.Affirmative, mySetting);
                        }));
                    }
                }
            ...
            static class CPU {
                public static async Task QueryCPUs(IDialogCoordinator dialogCoordinator) {
                    ...
                    if (!Helpers.InternalCheckIsWow64()) {
                        ...
                        await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                        {
                            ...
                            var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("Warning_with_Exclamation"), International.GetText("Form_Main_msgbox_CPUMining64bitMsg"), MessageDialogStyle.Affirmative, mySetting);
                        }));
                    ...
                    if (ThreadsPerCPU * Avaliable.CPUsCount > 64)
                    {
                        await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                        {
                            ...
                            var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("Warning_with_Exclamation"), International.GetText("Form_Main_msgbox_CPUMining64CoresMsg"), MessageDialogStyle.Affirmative, mySetting);
                        }));
            ...
            static class AMD {
                static public async Task QueryAMD(IDialogCoordinator dialogCoordinator) {
                    ...
                    if (ConfigManager.GeneralConfig.ShowDriverVersionWarning && ShowWarningDialog == true)
                    {
                        await Application.Current.Dispatcher.BeginInvoke(new Action(() =>
                        {
                            ...
                            var result = dialogCoordinator.ShowModalMessageExternal(MainViewModel, International.GetText("DriverVersionConfirmationDialog_title"), International.GetText("DriverVersionConfirmationDialog_labelWarning"), MessageDialogStyle.Affirmative, mySetting);
                        }));
        ...
        public static class Group {
            ...
            public static void EnableCpuGroup()
            {
                foreach (var device in Avaliable.AllAvaliableDevices)
                {
                    if (device.DeviceType == DeviceType.CPU)
